module.exports = {
    logs: {
        ...
        register: 'kayıt-log',
        name: 'name-log',
        responsibilites: 'sorumluluk-log',
        meeting: 'toplantı-log',
        complaint: 'şikayet-log',
        tagjoin: 'tag-alanlar',
        tagleave: 'tag-salanlar',
        staff: 'yetkiye-başlayan',
        upstaff: 'yetki-yükseltimleri',
        unstaff: 'yetki-salanlar',
        orientation: 'oryantasyon-log',
        message: 'mesaj-log',
        voice: 'ses-log',
        streamer: 'yayıncı-log',
        role: 'role-log',
        bannedtag: 'yasaklıtag-log',
    },

    process: {
        streamer: 'streamer-cezalı-bilgi',
        event: 'etkinlik-cezalı-bilgi', 
        mute: 'chat-mute-bilgi',
        vmute: 'voice-mute-bilgi',
        ban: 'cezalı-bilgi',
    },
    ...
    emojis: [
        { name: 'check', url: 'https://cdn.discordapp.com/emojis/1310286481335648297.webp?size=80' },
        { name: 'mark', url: 'https://cdn.discordapp.com/emojis/1310286479712456764.webp?size=80' },
        ...
        { name: 'arrow', url: 'https://cdn.discordapp.com/emojis/1312465201903304756.webp?size=80&animated=true'},
        { name: 'change', url: 'https://cdn.discordapp.com/emojis/1280996856343826554.webp?size=80&quality=lossless' },
        { name: 'limit', url: 'https://cdn.discordapp.com/emojis/1280996757773222042.webp?size=80&quality=lossless' },
        { name: 'lock', url: 'https://cdn.discordapp.com/emojis/1280996771169828944.webp?size=80&quality=lossless' },
        { name: 'visible', url: 'https://cdn.discordapp.com/emojis/1280996886119055462.webp?size=80&quality=lossless' },
        { name: 'member', url: 'https://cdn.discordapp.com/emojis/1280996814190809140.webp?size=80&quality=lossless' }
    ],
