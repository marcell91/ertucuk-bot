...
module.exports = async (message, options) => {
  ...
  if (typeof options.emojis.spades !== 'string')
    throw new Error(
      `[INVALID_PARAMATER] The emojis.spades option expected a string, but recieved ${typeof options.emojis.spades}`
    );
  if (typeof options.emojis.hearts !== 'string')
    throw new Error(
      `[INVALID_PARAMATER] The emojis.hearts option expected a string, but recieved ${typeof options.emojis.hearts}`
    );
  if (typeof options.emojis.diamonds !== 'string')
    throw new Error(
      `[INVALID_PARAMATER] The emojis.diamonds option expected a string, but recieved ${typeof options.emojis.diamonds}`
    );
  if (typeof options.emojis.clubs !== 'string')
    throw new Error(
      `[INVALID_PARAMATER] The emojis.clubs option expected a string, but recieved ${typeof options.emojis.clubs}`
    );
  ...
  if (commandType === 'interaction' && !message.deferred && !message.replied) {
    ...
    starterMessage = await message.reply({
      embeds: [
        {
          title: 'Oyun başlıyor.',
          description: 'Blackjack başlamak üzere, hazır olmalısın!',
        },
      ],
    });
  }
  ...
  let winEmbed = {
    author: {
      name: message.author.displayName + ` | ${options.bahis}$ kullandınız.`,
  ...
  let splitWinEmbed = {
    ...
    title: 'Böldün ve iki elide kazandın!',
    color: 0x008800,
    description: '',
    fields: [],
  };
  let splitLoseEmbed = {
    ...
    title: 'Böldün ve iki elide kaybettin!',
    color: 0xff0000,
    description: '',
    fields: [],
  };
  let splitTieEmbed = {
    ...
    title: 'Böldün ve berabere kaldın!!',
    color: 0xffff00,
    description: '',
    fields: [],
  };
  let splitTieWinEmbed = {
    ...
    title: 'Çift Rekabet: İlk el berabere kaldın, ikinci el kazandın.',
    color: 0x008800,
    description: '',
    fields: [],
  };
  let splitWinTieEmbed = {
    ...
    title: 'Çift Rekabet: İlk eli kazandın, ikinci el berabere kaldın.',
    color: 0x008800,
    description: '',
    fields: [],
  };
  let splitTieLoseEmbed = {
    ...
    title: 'Çift Rekabet: İlk el berabere kaldın, ikinci el kaybettin.',
    color: 0xff0000,
    description: '',
    fields: [],
  };
  let splitLoseTieEmbed = {
    ...
    title: 'Çift Rekabet: İlk eli kaybettin, ikinci el berabere kaldın!.',
    color: 0xff0000,
    description: '',
    fields: [],
  };
  let splitWinLoseEmbed = {
    ...
    title: 'Çift Rekabet: İlk eli kazandın, ikinci eli kaybettin.',
    color: 0xffff00,
    description: '',
    fields: [],
  };
  let splitLoseWinEmbed = {
    ...
    title: 'Çift Rekabet: İlk eli kaybettin ikinci el kazandın.',
    color: 0xffff00,
    description: '',
    fields: [],
  };
  ...
  let timeoutEmbed = {
    ...
    color: 0xff0000,
    description:
      '30 Saniye boyunca cevap verilemediğinden dolayı oyun iptal edildi.',
    fields: [],
  };
  let cancelEmbed = {
    author: {
  ...
  let generalEmbed =
    normalEmbed === false
      ...
      : {
        author: {
          name:
            message.author.displayName + ` | ${options.bahis}$ kullandınız.`,
          icon_url: message.author.displayAvatarURL(),
        },
        title: 'Blackjack',
        color: Math.floor(Math.random() * (0xffffff + 1)),
        fields: [
          { name: 'Senin elin', value: '', inline: true },
          { name: `Botun eli`, value: '', inline: true },
        ],
      };
  ...
  generalEmbed.fields[0].value = `Kartlar: ${yourcards.map((c) => `[\`${c.emoji} ${c.rank}\`](https://ertu.live)`).join(' ')}\nToplam:${isSoft ? ' Soft' : ''} ${yourcards.map((c) => c.value).reduce((a, b) => b + a)}`;
  generalEmbed.fields[1].value = `Kartlar: [\`${dealercards[0].emoji} ${dealercards[0].rank}\`](https://ertu.live) \` ? \`\nToplam: \` ? \``;
  ...
  if (yourvalue === 21 && dealervalue != 21) {
    if (options.resultEmbed === true) {
      ...
      winEmbed.fields.push({
        name: 'Senin elin',
        value: `Kartlar: [\`${yourcards[0].emoji} ${yourcards[0].rank}\`](https://ertu.live) [\`${yourcards[1].emoji} ${yourcards[1].rank}\`](https://ertu.live)\nToplam: ${yourvalue}`,
      });
      winEmbed.fields.push({
        name: 'Botun eli',
        value: `Kart: [\`${dealercards[0].emoji} ${dealercards[0].rank}\`](https://ertu.live) [\`${dealercards[1].emoji} ${dealercards[1].rank}\`](https://ertu.live)\nToplam: ${dealervalue}`,
      });
      commandType === 'message'
  ...
  //         loseEmbed.fields.push({ name: "Senin elin", value: `Kartlar: [\`${yourcards[0].emoji} ${yourcards[0].rank}\`](https://ertu.live) [\`${yourcards[1].emoji} ${yourcards[1].rank}\`](https://ertu.live)\nToplam: ${yourvalue}` })
  //         loseEmbed.fields.push({ name: "Botun eli", value: `Kartlar: [\`${dealercards[0].emoji} ${dealercards[0].rank}\`](https://ertu.live) [\`${dealercards[1].emoji} ${dealercards[1].rank}\`](https://ertu.live)\nToplam: ${dealervalue}` })
  ...
  // }
    ...
    if (options.resultEmbed === true) {
      ...
      tieEmbed.fields.push({
        name: 'Botun eli',
        value: `Kartlar: [\`${dealercards[0].emoji} ${dealercards[0].rank}\`](https://ertu.live) [\`${dealercards[1].emoji} ${dealercards[1].rank}\`](https://ertu.live)\nToplam: ${dealervalue}`,
      });
      commandType === 'message'
  ...
  if (options.resultEmbed === true) {
    ...
    finalEmbed.fields.push({
      name: `Senin elin`,
      value: `Kartlar: ${finalResult.ycard.map((c) => `[\`${c.emoji} ${c.rank}\`](https://ertu.live)`).join(' ')}\nToplam: ${finalResult.ycard.map((card) => card.value).reduce((a, b) => b + a)}`,
      inline: true,
    });
    if (finalResult.ycard2 != null) {
      finalEmbed.fields.push({
        name: `İkinci elin`,
        value: `Kartlar: ${finalResult.ycard2.map((c) => `[\`${c.emoji} ${c.rank}\`](https://ertu.live)`).join(' ')}\nToplam: ${finalResult.ycard2.map((card) => card.value).reduce((a, b) => b + a)}`,
        inline: true,
      });
    }
    finalEmbed.fields.push({
      name: `Botun eli`,
      value: `Kartlar: ${finalResult.dcard.map((c) => `[\`${c.emoji} ${c.rank}\`](https://ertu.live)`).join(' ')}\nToplam: ${finalResult.dcard.map((card) => card.value).reduce((a, b) => b + a)}`,
      inline: true,
    });
