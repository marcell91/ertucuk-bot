...
module.exports = {
    ...
    Description: 'Belirtilen üyenin parasını siler.',
    Usage: 'parakaldır <@User/ID> <miktar>',
    Category: 'Root',
    Cooldown: 0,
    ...
    messageRun: async (client, message, args) => {
        ...
        message.reply({ content: `Başarıyla ${member} kullanıcısının bankasından ${client.functions.formatNumber(args[1])}$ çektiniz.` })
    },
};
